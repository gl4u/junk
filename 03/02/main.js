...
const StudentsGroup = React.createClass({
    render() {
        return (
            <div >
                {
...
const SearchBar =  React.createClass({
    ...
    render () {
        return (
            <div className="search-left-inner-addon">
...
const FilterableStudentsGroup = React.createClass({
    ...
    filterStudentsByName(filter) {
        if (filter) {
            return this.props.students.filter(student => student.name.indexOf(filter) !== -1);
        }
    ...
    handleSearchInput(filterText) {
        this.setState({
            students: this.filterStudentsByName(filterText)
        });
    },
    ...
    render() {
        return (
            <div className="group-body">
                <div className="heading">Search React Course Members</div>
                <SearchBar
...
ReactDOM.render(
    <FilterableStudentsGroup students={STUDENTS} />,
